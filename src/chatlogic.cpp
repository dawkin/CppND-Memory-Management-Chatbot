...
ChatLogic::~ChatLogic()
{
    //// STUDENT CODE
    ////
    // move operator took ownership of the chatbot to the graphnode
    // delete isn't needed anymore
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot local_chat_bot("../images/chatbot.png");
    local_chat_bot.SetChatLogicHandle(this);
    // add chatbot to graph root node
    local_chat_bot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(local_chat_bot));
